...
public class ProdutoDAOSerial implements Serializable {
	


	private static final long serialVersionUID = -4524358113966417633L;
	private Connection con;
	Produto prod =  new Produto();
	
	public ProdutoDAOSerial() throws RemoteException {
